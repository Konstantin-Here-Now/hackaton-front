...
class ServiceResponse {
    ...
    statusUpdated() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_TRUE, messageConstants_1.CODE_200, messageConstants_1.STATUS_SUCCESS_UPDATED);
    }
    jobInfoNotFound() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_FALSE, messageConstants_2.CODE_404, messageConstants_1.JOB_INFO_NOT_FOUND);
    }
    responsesDiscard() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_FALSE, messageConstants_2.CODE_403, messageConstants_1.RESPONSES_DISCARD);
    }
    recordsAlreadyExists() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_FALSE, messageConstants_2.CODE_403, messageConstants_1.RECORDS_ALREADY_EXISTS);
    }
    serviceMarketError() {
    ...
    recipeSuccessAdded() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_TRUE, messageConstants_1.CODE_200, messageConstants_1.RECIPE_SUCCESS_ADDED);
    }
    recordAlreadyExist() {
    ...
    responsesAddSuccess() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_TRUE, messageConstants_1.CODE_200, messageConstants_1.RECORD_ADD_SUCCESS);
    }
    doctorAlreadyExists() {
    ...
    recordUpdateSuccess() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_TRUE, messageConstants_1.CODE_200, messageConstants_1.RECORD_UPDATED_SUCCESS);
    }
}
